      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ 
          ...
          {teamData.map((member, index) => {
            ...
            const isRicardo = member.name === 'Ricardo Reis';

            return (
              <div 
                key={index} 
                className={`transition-all duration-300 hover:-translate-y-2 group ${isRicardo ? 'cursor-pointer' : ''}`} 
                onClick={() => isRicardo && navigate('/memorial')} 
                style={{
                  padding: '40px 30px',
              ...
              >
                ...
                <p style={{ 
                  ...
                  {modoRebelde ? member.name.toUpperCase() : member.name}
                </p>
